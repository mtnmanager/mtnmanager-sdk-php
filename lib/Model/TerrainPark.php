 ...
 */
class TerrainPark implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TerrainPark';
    ...
    */
     ...
     * Sets uuid
     *
     * @param string $uuid Unique identifier for the terrain park.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Display name of the terrain park.
     *
     * @return self
     */
     ...
     * Sets slug
     *
     * @param string $slug URL-friendly name of the terrain park.
     *
     * @return self
     */
     ...
     * Sets number
     *
     * @param int|null $number Optional terrain park number.
     *
     * @return self
     */
     ...
     * Gets status
     *
     * @return \MtnManager\Model\TerrainParkStatus
     */
     ...
     * Sets status
     *
     * @param \MtnManager\Model\TerrainParkStatus $status Current operational status (open, closed, or unknown).
     *
     * @return self
     */
     ...
     *
     * @param string $condition_notes Notes about current conditions in this terrain park.
     *
     * @return self
     */
     ...
     * Sets area_uuid
     *
     * @param string|null $area_uuid UUID of the area this terrain park belongs to, if assigned.
     *
     * @return self
     */
     ...
     * Sets area_name
     *
     * @param string|null $area_name Name of the area this terrain park belongs to, if assigned.
     *
     * @return self
     */
     ...
     *
     * @param int|null $area_display_order Display order of the area this terrain park belongs to, if assigned, for sorting purposes.
     *
     * @return self
     */
     ...
     * Gets features
     *
     * @return \MtnManager\Model\TerrainParkFeature[]
     */
     ...
     * Sets features
     *
     * @param \MtnManager\Model\TerrainParkFeature[] $features Features within this terrain park (jumps, boxes, rails, etc.).
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime $updated_at When this terrain park or any of its features was last updated.
     *
     * @return self
     */
