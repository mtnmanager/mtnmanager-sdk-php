...
class Lift implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPIFormats = [
        ...
        'length_ft' => 'int32',
        'length_m' => 'int32',
        'vertical_rise_ft' => 'int32',
        'vertical_rise_m' => 'int32',
        'status' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'length_ft' => true,
        'length_m' => true,
        'vertical_rise_ft' => true,
        'vertical_rise_m' => true,
        'status' => false,
    ...
    protected static $setters = [
        ...
        'length_m' => 'setLengthM',
        'vertical_rise_ft' => 'setVerticalRiseFt',
        'vertical_rise_m' => 'setVerticalRiseM',
        'status' => 'setStatus',
    ...
    protected static $getters = [
        ...
        'length_m' => 'getLengthM',
        'vertical_rise_ft' => 'getVerticalRiseFt',
        'vertical_rise_m' => 'getVerticalRiseM',
        'status' => 'getStatus',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('vertical_rise_ft', $data ?? [], null);
        $this->setIfExists('vertical_rise_m', $data ?? [], null);
     ...
     * Sets travel_time
     *
     * @param float|null $travel_time Estimated travel time in minutes.
     *
     * @return self
     */
    ...
    {
        return $this->container['length_ft'];
    }

    /**
     * Sets length_ft
     *
     * @param int|null $length_ft Length of the lift in feet.
     *
     * @return self
     */
    public function setLengthFt($length_ft)
    {
        if (is_null($length_ft)) {
            array_push($this->openAPINullablesSetToNull, 'length_ft');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('length_ft', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['length_ft'] = $length_ft;
    ...
    {
        return $this->container['length_m'];
    }

    /**
     * Sets length_m
     *
     * @param int|null $length_m Length of the lift in meters.
     *
     * @return self
     */
    public function setLengthM($length_m)
    {
        if (is_null($length_m)) {
            array_push($this->openAPINullablesSetToNull, 'length_m');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('length_m', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['length_m'] = $length_m;

        return $this;
    }

    /**
     * Gets vertical_rise_ft
     *
     * @return int|null
     */
    public function getVerticalRiseFt()
    {
        return $this->container['vertical_rise_ft'];
    }

    /**
     * Sets vertical_rise_ft
     *
     * @param int|null $vertical_rise_ft Vertical rise of the lift in feet.
     *
     * @return self
     */
    public function setVerticalRiseFt($vertical_rise_ft)
    {
        if (is_null($vertical_rise_ft)) {
            array_push($this->openAPINullablesSetToNull, 'vertical_rise_ft');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('vertical_rise_ft', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['vertical_rise_ft'] = $vertical_rise_ft;

        return $this;
    }

    /**
     * Gets vertical_rise_m
     *
     * @return int|null
     */
    public function getVerticalRiseM()
    {
        return $this->container['vertical_rise_m'];
    }

    /**
     * Sets vertical_rise_m
     *
     * @param int|null $vertical_rise_m Vertical rise of the lift in meters.
     *
     * @return self
     */
    public function setVerticalRiseM($vertical_rise_m)
    {
        if (is_null($vertical_rise_m)) {
            array_push($this->openAPINullablesSetToNull, 'vertical_rise_m');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('vertical_rise_m', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['vertical_rise_m'] = $vertical_rise_m;
     ...
     * Sets images
     *
     * @param \MtnManager\Model\EntityImage[]|null $images Images attached to this lift, ordered for display. Each includes a  ThumbHash for rendering a blurred placeholder while the image loads.
     *
     * @return self
     */
