 ...
 */
class ResortInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResortInfo';
    ...
    */
     ...
     * Sets uuid
     *
     * @param string $uuid Unique identifier for the resort.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Display name of the resort.
     *
     * @return self
     */
     ...
     * Sets slug
     *
     * @param string $slug URL-friendly identifier for the resort, used in account subdomain.
     *
     * @return self
     */
     ...
     * Sets timezone
     *
     * @param string $timezone IANA timezone identifier for the resort's local time.
     *
     * @return self
     */
    ...
    /**
     * Gets unit_preference
     *
     * @return \MtnManager\Model\UnitPreference
     */
    public function getUnitPreference()
    {
        return $this->container['unit_preference'];
    }

    /**
     * Sets unit_preference
     *
     * @param \MtnManager\Model\UnitPreference $unit_preference Preferred unit system for measurements (metric or imperial).
     *
     * @return self
     */
    public function setUnitPreference($unit_preference)
    {
        if (is_null($unit_preference)) {
