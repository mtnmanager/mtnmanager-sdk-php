...
/**
 * OverviewLifts Class Doc Comment
 *
 * @category Class
 ...
 */
class OverviewLifts implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'OverviewLifts';
     ...
     * Sets open
     *
     * @param int|null $open Number of lifts currently open.  Not included if the lifts status feature is disabled.
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param int $total Total number of lifts at the resort.
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime $updated_at When the most recent update to lift status was made.
     *
     * @return self
     */
