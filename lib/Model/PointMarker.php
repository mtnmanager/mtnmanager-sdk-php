...
/**
 * PointMarker Class Doc Comment
 *
 * @category Class
 * @description A point marker on a trail map, enriched with entity data where applicable.
 * @package  MtnManager
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PointMarker implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PointMarker';
