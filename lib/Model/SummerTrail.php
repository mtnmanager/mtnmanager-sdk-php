...
class SummerTrail implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets difficulty
     *
     * @param \MtnManager\Model\SummerTrailDifficulty|null $difficulty Difficulty rating of the trail (optional for summer trails).
     *
     * @return self
     */
     ...
     * Sets images
     *
     * @param \MtnManager\Model\EntityImage[]|null $images Images attached to this trail, ordered for display. Each includes a  ThumbHash for rendering a blurred placeholder while the image loads.
     *
     * @return self
     */
