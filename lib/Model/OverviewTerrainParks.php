 ...
 */
class OverviewTerrainParks implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'OverviewTerrainParks';
     ...
     * Sets open
     *
     * @param int|null $open Number of terrain parks currently open.  Not included if the terrain parks status feature is disabled.
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param int $total Total number of terrain parks at the resort.
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime $updated_at When the most recent update to terrain park status was made.
     *
     * @return self
     */
