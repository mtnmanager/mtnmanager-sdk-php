...
/**
 * HourlyForecastMetric Class Doc Comment
 *
 * @category Class
 ...
 */
class HourlyForecastMetric implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HourlyForecastMetric';
    ...
    */
     ...
     * Sets temperature
     *
     * @param int $temperature Temperature in Celsius
     *
     * @return self
     */
     ...
     * Sets feels_like
     *
     * @param int|null $feels_like Feels like temperature in Celsius
     *
     * @return self
     */
    public function setFeelsLike($feels_like)
    {
        if (is_null($feels_like)) {
            array_push($this->openAPINullablesSetToNull, 'feels_like');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('feels_like', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets snowfall
     *
     * @param int|null $snowfall Snowfall amount expected this hour in centimeters
     *
     * @return self
     */
     ...
     * Sets precipitation
     *
     * @param int|null $precipitation Precipitation amount expected this hour in millimeters
     *
     * @return self
     */
     ...
     * Sets wind_speed
     *
     * @param int $wind_speed Wind speed in km/h
     *
     * @return self
     */
     ...
     * Sets wind_gust
     *
     * @param int|null $wind_gust Wind gust in km/h
     *
     * @return self
     */
