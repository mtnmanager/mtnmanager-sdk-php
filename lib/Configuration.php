...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://your-resort.mtnmanager.com';
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/1.7.3/PHP';
    ...
    {
        $report  = 'PHP SDK (MtnManager) Debug Report:' . PHP_EOL;
