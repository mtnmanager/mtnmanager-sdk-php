...
**amenity_schedules** | [**\MtnManager\Model\AmenitySchedule[]**](AmenitySchedule.md) | Per-amenity operating schedules. Only included when amenity hours are configured. | [optional]
